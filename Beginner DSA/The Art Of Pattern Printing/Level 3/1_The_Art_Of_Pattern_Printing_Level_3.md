...
description: "Learn how to use mathematical inequalities and the logical AND (&&) operator to shade complex 2D regions."
---
...
But what if we don't just want the outline? What if we want to fill an entire *region* of the canvas?
...
To print the *inside* of the pyramid, we need to shade the region that is **greater than** the left line, AND **less than** the right line! We combine them using a logical `&&` (AND):
...
By now, you are a master of the Canvas Paradigm. You know that the geometric boundaries have absolutely nothing to do with *what* is printed. 
...
[![Pattern Printing: Regions and Inequalities](../Images/video-lecture-thumbnail.jpg)](https://drive.google.com/file/d/1hyia_ZHKnewe-OF5wTXESB3CW6WfaKuT/view?usp=drive_link)
