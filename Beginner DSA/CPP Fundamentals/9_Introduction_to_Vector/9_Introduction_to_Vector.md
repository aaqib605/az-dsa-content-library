...
description: "Discover Vectors, the dynamic arrays of C++. Learn how to push_back, traverse, and handle lists of data whose size changes at runtime."
---
...
![A visual showing a static array locked in a steel box, compared to a vector expanding as new blocks are added to the end.](../Images/vector_vs_array.png)
...
Vectors are the ultimate tool in a competitive programmer's arsenal. Let's practice using them!

- **[Vector AZ101](https://maang.in/problems/Vector-AZ101-344)**
- **[Lowest Number](https://maang.in/problems/Lowest-Number-1156)**
- **[Palindrome Array](https://maang.in/problems/Palindrome-Array-1154)**
- **[Lucky Array](https://maang.in/problems/Lucky-Array-1151)**
- **[Minimize Number](https://maang.in/problems/Minimize-Number-1148)**
- **[Sum Digits](https://codeforces.com/group/MWSDmqGsZm/contest/219774/problem/K)**
- **[Reverse](https://codeforces.com/group/MWSDmqGsZm/contest/219774/problem/F)**
- **[Smallest Pair](https://maang.in/problems/Smallest-Pair-1152)**
- **[Count Subarrays](https://maang.in/problems/Count-Subarrays-1147)**

---

## Video Explanation

[![Introduction to Vector](../Images/video-lecture-thumbnail.jpg)]()
