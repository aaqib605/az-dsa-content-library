...
description: "Learn the basic structure of a C++ program, syntax rules, and how your code runs on an Online Judge."
---
...
![Illustration of the C++ code snippet pointing to different parts like headers, namespace, main function, and return statement](../Images/cpp_structure.png)
...
![A side-by-side comparison of poorly indented unreadable code vs neatly indented code](../Images/code_indentation.png)
...
![A visual flowchart showing the journey of code: User submits -> Compilation -> Execution with secret tests -> Comparison -> Result (AC/WA/TLE/RE)](../Images/oj_flowchart.png)
