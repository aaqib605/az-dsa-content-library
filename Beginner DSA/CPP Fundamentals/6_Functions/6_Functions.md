---
title: "Functions: Just Enough to Organize Code"
slug: "functions-just-enough-to-organize-code"
track: "beginner-dsa"
level: "Beginner"
order: 6
status: "Draft"
...
description: "Learn how to break your code into smaller, reusable blocks using functions. Understand parameters, return types, and local scope."
---
...
![An illustration of a machine. Raw materials (parameters) go in one end, gears turn inside (the function body), and a finished product (return value) comes out the other end.](../Images/function_machine.png)
...
Writing custom functions will level up your problem-solving speed. Try solving these problems by isolating the core logic into its own helper function!

- **[Primes from 1 to n](https://maang.in/problems/Primes-from-1-to-n-1208)**
- **[Average](https://maang.in/problems/Average-1223)**
- **[Shift Right](https://maang.in/problems/Shift-Right-1224)**
- **[N Times](https://codeforces.com/group/MWSDmqGsZm/contest/223205/problem/H)**
- **[Wonderful Number](https://codeforces.com/group/MWSDmqGsZm/contest/223205/problem/C)**
...
[![Functions Just Enough to Organize Code](../Images/video-lecture-thumbnail.jpg)]()
