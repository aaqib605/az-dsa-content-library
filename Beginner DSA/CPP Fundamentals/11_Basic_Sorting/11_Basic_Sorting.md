...
description: "Learn how to use C++'s powerful built-in sorting algorithms to effortlessly organize arrays and vectors."
---
...
![A visual showing a disorganized array transforming into an organized ascending array passing through a glowing 'sort()' machine](../Images/sorting_machine.png)
...
![A visual diagram of a vector showing standard iterators (.begin() pointing to the first element, .end() pointing just past the last element) and reverse iterators (.rbegin() pointing to the last element, .rend() pointing just before the first element).](../Images/vector_iterators.png)
...
Sorting makes hard problems incredibly easy. Give these a try:

- **[Sort the Array](https://maang.in/problems/Sorting-1153)**
- **[STL Sorted](https://maang.in/problems/STL-Sorted-1043)**
- **[Sort by Roll Number](https://maang.in/problems/Sort-by-Roll-Number-352)**
- **[Sort String](https://codeforces.com/group/MWSDmqGsZm/contest/219856/problem/O)**
- **[Profit or Loss](https://maang.in/problems/Profit-or-Loss-1409)**
- **[Minimum Absolute Difference](https://maang.in/problems/Minimum-Absolute-Difference-509)**
- **[Buy Maximum Objects I](https://maang.in/problems/Buy-Maximum-Objects-I-75)**
- **[Permutation with arrays](https://codeforces.com/group/MWSDmqGsZm/contest/219774/problem/R)**
- **[Find Adjacent Pairs](https://maang.in/problems/Find-Adjacent-Pairs-1456)**
- **[Team Rankings](https://maang.in/problems/Team-Rankings-1431)**

---

## Video Explanation

[![Basic Sorting](../Images/video-lecture-thumbnail.jpg)]()
