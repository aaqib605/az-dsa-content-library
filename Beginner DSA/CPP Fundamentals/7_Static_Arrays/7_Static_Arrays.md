...
description: "Learn how to store multiple values of the same type in a single contiguous block of memory using static arrays."
---
...
![A visual representation of an array as a row of connected, numbered lockers holding different integer values](../Images/array_lockers.png)
...
Arrays are the most fundamental data structure. Master these problems, and you'll be well on your way to advanced algorithms.

Try solving the following problems:
- **[Searching](https://maang.in/problems/Searching-1159)**
- **[Replacement](https://maang.in/problems/Replacement-1158)**
- **[Position in Array](https://maang.in/problems/Position-in-Array-1157)**
- **[Reversing](https://maang.in/problems/Reversing-1155)**
- **[Sorting](https://maang.in/problems/Sorting-1153)**
- **[Max Subarray](https://maang.in/problems/Max-Subarray-1150)**
- **[Replace MinMax](https://maang.in/problems/Replace-MinMax-1149)**
- **[Permutation With Arrays](https://maang.in/problems/Permutation-With-Arrays-1146)**
- **[The Proxy Investigation](https://maang.in/problems/Is-B-a-subsequence-of-A-1143)**
- **[Frequency Array](https://maang.in/problems/Frequency-Array-1140)**

---

## Video Explanation

[![Static Arrays](../Images/video-lecture-thumbnail.jpg)]()
