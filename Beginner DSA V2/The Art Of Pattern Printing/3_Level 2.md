...
<VIDEO_ID>3446</VIDEO_ID> <!-- Required -->
...
In Level 1, we learned how to draw outer boundaries by checking the extreme coordinates (like `i == 0` or `j == M-1`). But what if we need to draw lines _across_ our canvas?
